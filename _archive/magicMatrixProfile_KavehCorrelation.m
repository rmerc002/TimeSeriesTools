function  [magicMP, profileIndices,subLenSeries] = magicMatrixProfile_KavehCorrelation(data)
data = normalize(data);
...
%     interactiveMatrixProfileVer2_sublenNorm(dataNoise, subLen, 0)

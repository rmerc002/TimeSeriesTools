function [matrixProfile, matrixProfileIdx, isvalidwindow, motifsIdx, discordsIdx] = mpx_v3_sum(timeseries, minlag, subseqlen, plot_output)
...
% matrixProfile = sqrt(2 * subseqlen * (1 - matrixProfile));

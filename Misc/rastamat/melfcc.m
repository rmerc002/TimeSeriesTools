...
%   - take the absolute value of the STFT %short time fourier transform
%   - warp to a Mel frequency scale
%   - take the DCT of the log-Mel-spectrum %% discrete cosine transform
%   - return the first <ncep> components %% signal aslie

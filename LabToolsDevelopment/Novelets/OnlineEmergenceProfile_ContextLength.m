...
classdef OnlineEmergenceProfile_ContextLength
    properties
        positiveTS
        negativeTS
    ...
    methods
        function obj = OnlineEmergenceProfile_ContextLength(positiveTS, negativeTS, mm, threshold, contextLength, startLocalOffset, endLocalOffset)
            if nargin < 1
               positiveTS = [];
            end

function  [magicMP, profileIndices,subLenSeries] = magicMatrixProfile(dataA,dataB, startLength, endLength, numLengths)
if size(dataA,1) > 1
    dataA = dataA';
end
...
%     [matrixProfile,profileIndex] = mpx_AB(dataA',dataB',subLen);
    [matrixProfile, pb, profileIndex, pib] = mpx_stringsAB(a', b', w)

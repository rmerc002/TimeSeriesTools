...
Ttest = Lab2Cmac011215{1:100:end,3};
labelsTest = Lab2Cmac011215{1:100:end,4} == positiveClass; %binary labels of positive class
...
for queryIndex = 1:size(queries,1)
    ...
    top1000 = 100*sum(labelsTest(bestIndices(1:1000)))/1000;
    ...
    %%% Plot Bin Breakdown %%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%
    plotBinBreakdownOfTopK(K, 10, labelsTest, bestIndices, defaultRate, queryLabel);
    plotBinBreakdownOfTopK(K, 100, labelsTest, bestIndices, defaultRate, queryLabel);
end

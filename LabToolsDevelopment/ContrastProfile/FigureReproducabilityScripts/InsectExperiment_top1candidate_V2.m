...
[plato, platoTop1candidate, platoTop2candidate] = PLATO(pos, neg, subLength, [1 1]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
queries = [platoTop1candidate';platoTop2candidate'; motifA'; motifB'];
queryLabels = ["PLATO_Top1","Plato_Top2","MotifA","MotifB"];

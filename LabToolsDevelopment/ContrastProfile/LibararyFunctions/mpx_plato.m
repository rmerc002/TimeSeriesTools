...
% output in euclidean norm distance

%last change made 2020-12-15
...
%1-(positive Pearson Correlation)

% mp = sqrt(1-max(0,mp)); %same ratios between distances as eudlicean distance
mp = sqrt(2*w*(1-mp));
